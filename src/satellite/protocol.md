...
| `caps` | — | `{"ok":true,"capabilities":[...]}` — only what the flashed edition implements: IDF `["wifi","gpio","siggen","ble"]`, Arduino `["wifi","gpio","siggen"]` (no BLE). Hosts gate instruments on this list. |
